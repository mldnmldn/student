...
<%!
	public static final String SCHEDULE_ADD_URL = "pages/back/admin/schedule/ScheduleAction!add.action";
							...
							<div class="form-group" id="noteDiv">
								...
								<div class="col-md-5">
									...
									<textarea id="note" name="note"
										class="form-control" placeholder="请输入任务了内容" rows="10"></textarea>
								</div>
								<!-- 定义表单错误提示显示元素 -->
