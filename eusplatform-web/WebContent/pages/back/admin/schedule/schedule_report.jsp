...
<script type="text/javascript" src="js/pages/back/admin/audit/audit_schedule_report.js"></script>
							...
							<div class="panel-heading">
								<h4 class="panel-title"> 
									<a data-toggle="collapse" data-parent="news" href="#contentOne">
										<strong><span class="glyphicon glyphicon-user"></span>&nbsp;任务报告（总人数：${Schedule.ecount}人、已提交报告：${repCount}人）</strong>
									</a>
								</h4>
							</div>
									...
									<table class="table table-condensed">
										...
										<tbody>
											<c:forEach items="${allEmp}" var="emp">
												...
												<td class="text-center">${allNote[emp.eid]}</td>
												</tr> 
											</c:forEach>
										</tbody>
									</table>
