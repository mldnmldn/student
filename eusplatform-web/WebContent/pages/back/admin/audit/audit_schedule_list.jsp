...
<script type="text/javascript" src="js/pages/back/admin/audit/audis_schedule_list_b.js"></script>
						...
						<tbody>
							<c:forEach items="${allSchedule}" var="schedule">
									...
									<td class="text-center">
										<button id="lsBut-${schedule.sid}" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-cloud-upload"></span>&nbsp;查看详情</button>
									</td>
