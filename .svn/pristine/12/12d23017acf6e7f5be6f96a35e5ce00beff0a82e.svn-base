...
<%!
	...
	public static final String DEPT_LIST_URL = "pages/back/admin/dept/DeptAction!list.action" ;
	public static final String DEPT_ADD_URL = "pages/back/admin/dept/dept_add.jsp" ;
	
	public static final String EMP_ADD_URL = "EmpBackAction!addPre.action" ;
	public static final String EMP_LIST_URL = "EmpBackAction!list.action" ;
	
	public static final String SCHEDULE_ADD_URL = "pages/back/admin/schedule/ScheduleAddAction!ListItem.action" ;
	public static final String SCHEDULE_LIST_SELF_URL = "pages/back/admin/schedule/ScheduleAddAction!list.action" ;
	
	public static final String SCHEDULE_AUDIT_URL = "pages/back/admin/schedule/ScheduleActionFront!check.action" ;
	public static final String SCHEDULE_LIST_URL = "pages/back/admin/schedule/ScheduleActionFront!list.action" ;
	
	public static final String EMP_SCHEDULE_PREPARE_URL = "pages/back/admin/schedule/SchedulePersonalTaskAction!list.action" ;
	public static final String EMP_SCHEDULE_LIST_URL = "pages/back/admin/schedule/SchedulePersonalTaskAction!listHistory.action" ;
%>
